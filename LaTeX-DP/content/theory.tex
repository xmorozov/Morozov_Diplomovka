...
\section{Controller Theory}\label{regulatory:teoria}
...
\begin{subequations}\label{mpcgeneral}
	\begin{align}
		\min_{u_0,...,u_{N-1}}\ &\sum_{k=0}^{N-1} \lrp{\left\| \ui{Q}{x}x_{k}\right\|_2+\left\|\ui{Q}{u}u_{k}\right\|_2}\\
...
\begin{algorithm}[H]
	...
	\State Choose steplength $\alpha$ so that
	\begin{equation}
	f(x_k + \alpha d_x)<f(x_k).
	\end{equation}
